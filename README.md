<p align="center">
  <img src="https://raw.githubusercontent.com/naer-lily/asuka/main/resources/icon.png" alt="Asuka" width="96">
</p>
...
src/main/          Electron 主进程
  index.ts           入口 + 应用生命周期
  bubble-window.ts   悬浮窗管理（创建/展开/收拢/移动）
  ipc-handlers.ts    IPC 事件处理（拖放/点击/右键）
  clipboard-monitor.ts 剪贴板监控
  tray.ts            系统托盘
src/preload/       contextBridge — 向渲染进程暴露 IPC API
src/renderer/      Vue 3 SPA — 悬浮球 UI
src/shared/        共享类型与常量
```
